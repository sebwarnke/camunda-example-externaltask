package org.camunda.warnke.examples.externaltask;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "externaltask";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "externaltask.war")
            ...
            .addPackages(false, "org.camunda.warnke.examples.externaltask") // not recursive to skip package 'nonarquillian'
